  ...
  <section class="flex justify-center py-10">
    <div class="w-[500px]">
      ...
      <form @submit.prevent="createProduct">
        ...
        <button type="submit" class="text-black bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
          <span v-if="!isLoading">Submit</span>
          <div v-else class="flex items-center gap-3">
              <div class="w-5 h-5 rounded-full border-2 border-t-blue-400 animate-spin"></div>
              <span>Loading</span>
          </div>
        </button>
      </form>
